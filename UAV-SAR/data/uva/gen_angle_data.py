...
from ThridOrderRep import getThridOrderRep

# bone

def gen_angle_data_one_num_worker(path):
    if os.path.basename(path) == '/home/zjl_laoshi/quminghaonan/dataset/data_sar/MMVRAC_CSv2_test_bone.npz':
...
if __name__ == '__main__':
    gen_angle_data_one_num_worker('/home/zjl_laoshi/quminghaonan/dataset/data_sar/MMVRAC_CSv2_test_bone.npz')
